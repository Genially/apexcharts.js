      ...
      r(t, [
        ...
        },
        {
          ...
          value: function(t) {
            ...
            var e = 0,
              i = t.replace(/xmlns="http:\/\/www.w3.org\/2000\/svg"/g, function(
                t
              ) {
                return 2 === ++e
    ...
    return (
      r(t, [
        ...
        },
        {
          ...
          value: function(t) {
            'Enter' === t.key && this.onLegendClick(t)
          }
        }
      ]),
      t
        ...
        },
        {
          ...
          value: function(t) {
            var e = this.w,
              ...
              s =
                a >= 2 && a % 2 == 0 ? Math.floor(a / 2) : Math.floor(a / 2) + 1
            e.globals.isBarHorizontal &&
        ...
        },
        {
          ...
          value: function(t) {
            ...
            var a = t.xDivision,
              ...
              f = ''
            this.isBoxPlot &&
              (f = [this.boxOptions.colors.lower, this.boxOptions.colors.upper])
          ...
          value: function(t, i, a, s) {
            ...
            for (var c = [], d = 0; d < t.length; d++) {
              ...
              ;(k = this.lineHelpers.determineFirstPrevY({
                ...
                (x = k)
              'rangeArea' === n &&
                (v = A = this.lineHelpers.determineFirstPrevY({
                  i: d,
                  series: s,
                  prevY: A,
                  lineYPosition: 0
        ...
        extend: {
          ...
          lines: function() {
            var t = ((this.textPath && this.textPath()) || this).node,
              e = a.utils.map(a.utils.filterSVGElements(t.childNodes), function(
                t
              ) {
                return a.adopt(t)
              })
      ...
      r(t, [
        {
          ...
          value: function() {
            ;(this.ctx.publicMethods = [
              ...
              (this.ctx.responsive = new Q(this.ctx)),
